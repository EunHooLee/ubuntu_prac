...
#include "tutorial_interfaces/msg/imu__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/primitives_sequence.h"  // imu
#include "rosidl_generator_c/primitives_sequence_functions.h"  // imu

// forward declare type support functions


using _IMU__ros_msg_type = tutorial_interfaces__msg__IMU;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: imu
  {
    size_t size = ros_message->imu.size;
    auto array_ptr = ros_message->imu.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: imu
  {
    ...
    if (ros_message->imu.data) {
      rosidl_generator_c__float__Sequence__fini(&ros_message->imu);
    }
    if (!rosidl_generator_c__float__Sequence__init(&ros_message->imu, size)) {
      return "failed to create array for field 'imu'";
    }
    auto array_ptr = ros_message->imu.data;
...
size_t get_serialized_size_tutorial_interfaces__msg__IMU(
  const void * untyped_ros_message,
...
static uint32_t _IMU__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_interfaces__msg__IMU(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
size_t max_serialized_size_tutorial_interfaces__msg__IMU(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_tutorial_interfaces__msg__IMU(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces, msg, IMU)() {
