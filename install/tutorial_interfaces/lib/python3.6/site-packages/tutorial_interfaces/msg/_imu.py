...
class IMU(metaclass=Metaclass_IMU):
    ...
    def __init__(self, **kwargs):
        ...
        self.imu = array.array('f', kwargs.get('imu', []))
    ...
    def imu(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'f', \
                "The 'imu' array.array() must have the type code of 'f'"
            self._imu = value
            return
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'imu' field must be a set or sequence and each value of type 'float'"
        self._imu = array.array('f', value)
