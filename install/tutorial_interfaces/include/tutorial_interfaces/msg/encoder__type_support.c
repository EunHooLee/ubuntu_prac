...
#include <stddef.h>
#include "tutorial_interfaces/msg/encoder__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Encoder__rosidl_typesupport_introspection_c__Encoder_message_member_array[1] = {
  {
    ...
    offsetof(tutorial_interfaces__msg__Encoder, encoder),  // bytes offset in struct
    NULL,  // default value
