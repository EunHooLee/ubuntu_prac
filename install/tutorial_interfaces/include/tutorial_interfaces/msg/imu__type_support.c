...
#include <stddef.h>
#include "tutorial_interfaces/msg/imu__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember IMU__rosidl_typesupport_introspection_c__IMU_message_member_array[1] = {
  {
    "imu",  // name
    ...
    offsetof(tutorial_interfaces__msg__IMU, imu),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers IMU__rosidl_typesupport_introspection_c__IMU_message_members = {
  ...
  "IMU",  // message name
  1,  // number of fields
  sizeof(tutorial_interfaces__msg__IMU),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tutorial_interfaces, msg, IMU)() {
